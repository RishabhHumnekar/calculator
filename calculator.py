...
btn_mul = Button(root,text='*',bg='grey',fg='white',width=5,height=2,command=lambda :get_operator('*'))
btn_mul.config(font=('verdana',14))
btn_mul.grid(row=3,column=3)


btn_clr = Button(root,text='clr',bg='grey',fg='white',width=5,height=2,command=lambda :clear())
...
btn_equals = Button(root,text='=',bg='grey',fg='white',width=5,height=2,command=get_result)
btn_equals.config(font=('verdana',14))
btn_equals.grid(row=4,column=2)

btn_div = Button(root,text='/',bg='grey',fg='white',width=5,height=2,command=lambda :get_operator('/'))
